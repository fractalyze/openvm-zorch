...
- **Native baseline:** [`docs/native-baseline.md`](docs/native-baseline.md) — the native (Rust) prover wall-clock milestone #4 measures against, what is timed, the CPU-only caveat.
